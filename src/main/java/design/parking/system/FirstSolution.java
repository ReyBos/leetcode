 ...
 *
 * Result:
 * Runtime: 8 ms, faster than 19.55% of Java online submissions
 * Memory Usage: 51.6 MB, less than 8.55% of Java online submissions
 */

public class FirstSolution {
    private final int[] capacity;

    public FirstSolution(int big, int medium, int small) {
        capacity = new int[3];
        capacity[0] = big;
        capacity[1] = medium;
        capacity[2] = small;
