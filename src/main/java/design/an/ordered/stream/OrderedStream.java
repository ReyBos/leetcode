 ...
 * (list) of values after each insertion.
 * The concatenation of all the chunks should result in a list of the sorted values.
 *
 * Implement the OrderedStream class:
 *
 * OrderedStream(int n) Constructs the stream to take n values.
 * String[] insert(int id, String value) Inserts the pair (id, value) into the stream, then returns
 ...
 *
 * Result:
 * Runtime: 67 ms, faster than 77.63% of Java online submissions
 * Memory Usage: 40.2 MB, less than 89.55% of Java online submissions
 */
...
public class OrderedStream {
    ...
    public List<String> insert(int id, String value) {
        ...
        while (point != (store.length + 1) && store[point - 1] != null) {
            rsl.add(store[point - 1]);
            point++;
        }
        return rsl;
    }
